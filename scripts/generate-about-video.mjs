/**
 * generate-about-video.mjs
 * One ambient Vienna Kaffeehaus clip for the About page hero —
 * warm, inviting, evokes "let's meet for coffee" vibe.
 *
 * Run:
 *   set VOLCENGINE_ARK_KEY=ark-xxxxxxx
 *   node scripts/generate-about-video.mjs
 */
...
const CLIPS = [
  {
    name: 'kaffeehaus',
    text:
      '电影级慢推镜头，维也纳古典 Kaffeehaus 咖啡馆室内场景，' +
      '黄昏暖金色阳光从大窗斜射进来，照在大理石小圆桌和深色木椅上，' +
      '镜头沿吧台缓慢平移，远处隐约可见一杯热咖啡升起的蒸汽，墙上贴着报纸架。' +
      'Anamorphic 宽屏、浅景深、4K 写实、温暖色调、无明显人脸特写。5 秒。',
  },
];
