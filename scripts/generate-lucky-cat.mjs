...
const CLIP = {
  name: 'lucky-cat-gold',
  text:
    '电影级宽屏构图，一只通体金色的传统招财猫陶瓷摆件**完整摆放在画面右侧三分之一处**，' +
    '猫体完整可见从头到底座，右前爪缓慢上下挥动招手动作（持续重复），' +
    '脖子上挂着红色绸带与铃铛。' +
    '**画面左侧三分之二是温暖虚化的深色室内空间**（留白用），' +
    '柔和金色阳光从右侧大窗斜射进来照亮招财猫。' +
    'Anamorphic 宽屏 16:9、浅景深、4K 写实、温暖色调、无人物、无字幕。5 秒。',
};
